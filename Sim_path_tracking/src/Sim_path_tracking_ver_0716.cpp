...
class PurePursuit
{
    ...
    private:
        ros::NodeHandle n_;
        ros::Subscriber pose_sub, odom_sub, path_sub, goal_sub, amcl_sub, state_sub,vel_sub,joy_sub,parking_path_sub,parking_state_sub;
        ros::Publisher cmdvel_pub, marker_pub,ctrlVel_pub;
        ...
        morai_msgs::CtrlCmd ctrl_vel;

        nav_msgs::Odometry odom;
        geometry_msgs::PoseWithCovariance Cpose;
        ...
        int controller_freq;
        int go_vel_from, stop_vel_from, cross_road_vel_from,slow_down_for_traffic_light_vel_from,static_obs_vel_from,outbreak_obs_vel_from,parking_search_vel_from,parking_in_vel_from,parking_wait_vel_from,parking_out_vel_from,finish_vel_from;
        int go_vel_to, stop_vel_to, cross_road_vel_to,slow_down_for_traffic_light_vel_to,static_obs_vel_to,outbreak_obs_vel_to,parking_search_vel_to,parking_in_vel_to,parking_wait_vel_to,parking_out_vel_to,finish_vel_to;
        bool foundForwardPt, goal_received, goal_reached, cmd_vel_mode, debug_mode, smooth_accel;

        double angle_avg=0;
        void odomCB(const nav_msgs::Odometry::ConstPtr& odomMsg);
        void poseCB(const geometry_msgs::PoseWithCovariance::ConstPtr& poseMsg);
...
/*****************************************************************************************/
   ...
   cross_road_vel_from=100;
   cross_road_vel_to=200;


   slow_down_for_traffic_light_vel_from=50;
   slow_down_for_traffic_light_vel_to=50;


   static_obs_vel_from=100;
   static_obs_vel_to =150;


   outbreak_obs_vel_from=100;
   outbreak_obs_vel_to=150;

   parking_search_vel_from=50;
   parking_search_vel_to=100;


   parking_in_vel_from=50;
   parking_in_vel_to=50;
   ...
   parking_out_vel_from=-50;
   parking_out_vel_to=-50;
...
/****************************************************************************************/
  ...
  //  pn.param("base_angle", base_angle, -0.08726); // neutral point of servo (rad)
    ...
    pose_sub = n_.subscribe("/Perception/Localization/LocalPose", 1, &PurePursuit::poseCB, this);
    ...
    ctrlVel_pub = n_.advertise<morai_msgs::CtrlCmd>("crtl_msg");
...
void PurePursuit::poseCB(const geometry_msgs::PoseWithCovariance::ConstPtr& poseMsg)
{
    this->Cpose = *poseMsg;
}
...
{
    geometry_msgs::Point car_pose = this->pose.pose.position;
...
void PurePursuit::controlLoopCB(const ros::TimerEvent&)
{
    ...
    geometry_msgs::Pose carPose = this->pose.pose;
...
*/
 ...
 this->velocity = parking_search_vel_to-vel_penalty;
    ...
    {
        this->ctrl_vel.velocity = this->velocity;
        this->ctrl_vel.steering = this->velocity;
