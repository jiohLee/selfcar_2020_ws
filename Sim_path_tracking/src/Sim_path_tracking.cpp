...
class PurePursuit
{
    ...
    private:
        ...
        int controller_freq;
        double go_vel_from, stop_vel_from, cross_road_vel_from,slow_down_for_traffic_light_vel_from,static_obs_vel_from,outbreak_obs_vel_from,parking_search_vel_from,parking_in_vel_from,parking_wait_vel_from,parking_out_vel_from,finish_vel_from,slow_down_vel_from;
        double go_vel_to, stop_vel_to, cross_road_vel_to,slow_down_for_traffic_light_vel_to,static_obs_vel_to,outbreak_obs_vel_to,parking_search_vel_to,parking_in_vel_to,parking_wait_vel_to,parking_out_vel_to,finish_vel_to,slow_down_vel_to;
...
/*****************************************************************************************/
   ...
   static_obs_vel_to =130.0*velocity_gain;
